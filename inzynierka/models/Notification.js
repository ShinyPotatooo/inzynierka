...
module.exports = (sequelize) => {
  const Notification = sequelize.define('Notification', {
    ...
    userId: {
      // UWAGA: to jest odbiorca pojedynczy (adresat), kompatybilnie z audienceSql
      type: DataTypes.INTEGER,
      allowNull: true,
    ...
    // globalne isRead/isSent (zostawione dla wstecznej zgodności)
